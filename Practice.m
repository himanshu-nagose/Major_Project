...
Nt = 64;            % Number of antenna at the transmitter side
NtRF = 4;           % Number of RF Chain at the transmitting side
Nr = 16;            % Number of antenna at the recieving side
NrRF = 4;           % Number of RF Chain at the recieving side
rng(4096);          % rng = random number generator
c = 3e8;            % c= speed of light i.e 3 x 10^8 m/s
fc = 28e9;          % fc = frequency i.e 28 x 10^9 = 28GHz
lambda = c / fc;    % lambda = wavelength i.e 
